...
Author: [BorelEnzo](https://borelenzo.github.io/CTFs/Finals_CSC_BE_2019/crack_me/)

> I tried to solve this challenge from a crackme site, but the binary always exits when I start it
:((
Solve it for me!!

We are given a stripped 64-bit [binary](assets/crack_me), which exits immediately as it runs. Radare2 gave us the following routines:
