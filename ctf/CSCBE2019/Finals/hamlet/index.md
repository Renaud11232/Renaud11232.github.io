...
For this challenge we were given a paper named `Romeo and Juliet` containing some very weird dialogs between some of the characters from the play. Here is the text:
```
Romeo and Juliet.
